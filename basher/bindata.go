...
func scriptsMainBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts/main.bash", size: 8187, mode: os.FileMode(420), modTime: time.Unix(1466945441, 0)}
