...
func scriptsBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "scripts.bash", size: 9712, mode: os.FileMode(420), modTime: time.Unix(1467835370, 0)}
